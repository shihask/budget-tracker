...
export function PlantPage({ open, onClose, state }: Props) {
  const c = useTheme()
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        padding: 'calc(env(safe-area-inset-top, 16px) + 10px) 16px 10px',
        background: c.bg,
        ...
        <button
          ...
          style={{
            ...
            color: c.accent, font: '600 15px Plus Jakarta Sans',
          }}
        >
        ...
        <span style={{ flex: 1, textAlign: 'center', font: '700 16px Plus Jakarta Sans', color: c.ink, marginRight: 52 }}>
          Your MoneyPlant
        </span>
      </div>
