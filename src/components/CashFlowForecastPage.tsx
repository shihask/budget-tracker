...
export function CashFlowForecastPage({ state, d, onClose, onSetup }: Props) {
  const c = useTheme()
    ...
    <div style={{
      ...
      <div style={{ maxWidth: 560, margin: '0 auto', padding: '18px 16px calc(40px + env(safe-area-inset-bottom,0px))' }}>
        ...
        <div style={{ marginBottom: 18 }}>
          ...
          <div style={{ font: `600 12px ${F}`, color: c.muted, marginTop: 2 }}>Forecast · next ${state.settings.forecast_days ?? 60} days</div>
        </div>
